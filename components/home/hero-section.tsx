...
const HeroSection = () => {
  return (
    <section className="relative mx-auto min-h-full w-full overflow-hidden bg-linear-to-br from-purple-950 via-indigo-950 to-indigo-950">
      {/* Gradient overlay */}
      <div className="absolute inset-0 before:absolute before:left-1/4 before:top-0 before:h-125 before:w-125 before:rounded-full before:bg-linear-to-r before:from-violet-600/20 before:to-indigo-600/20 before:blur-3xl" />
